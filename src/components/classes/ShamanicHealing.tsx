...
export default function ShamanicHealing () {
  return (
        ...
        >
          <div className='relative rise'>
            ...
            <p className='mt-8 max-w-full text-[17px] leading-relaxed text-[#3A3325]'>
              ...
              help clear energetic blockages and support personal
              transformation.
            </p>
        ...
        >
          ...
          <div className='md:order-1'>
            ...
            <p className='mt-6 text-base leading-relaxed text-[#D8CFBB]'>
              ...
              Healing aims to clear these blockages, restore energy flow, and
              help individuals reconnect with their inner strength and purpose.
            </p>
          </div>
        </div>
      </section>
