...
export default function QuanyinHealing () {
  return (
        ...
        >
          ...
          <div className='md:order-1'>
            ...
            <p className='mt-6 text-base leading-relaxed text-[#D8CFBB]'>
              ...
              Forgiveness, and Unconditional Love. This healing practice focuses
            ...
            <p className='mt-6 text-base leading-relaxed text-[#D8CFBB]'>
              ...
              self-love. It is often used as a tool for personal healing,
      ...
      <section id='learn' className={`${sectionContainer} ${sectionSpace}`}>
        <div className='grid gap-16 md:grid-cols-[0.85fr_1.15fr]'>
          <div>
            ...
            <SectionTitle>How Does Quan Yin Healing Work?</SectionTitle>
            <p className='mt-6 text-[15px] leading-relaxed text-[#4A4331]'>
              Quan Yin Healing works by channeling compassionate healing energy
       ...
       <div className='absolute inset-0 bg-linear-to-b from-[#12100C]/50 via-[#12100C]/80 to-[#12100C]/95' />
        ...
        <div className='relative mx-auto max-w-full px-10 py-28 md:py-20'>
          ...
          <p className='font-serif text-2xl  leading-snug text-[#F6F1E7] md:text-2xl'>
            ...
            individuals can release emotional burdens, cultivate inner peace,
