...
export default function SacredGreen () {
  return (
        ...
        >
          <div className='relative rise'>
            ...
            <p className='mt-8 max-w-full text-[17px] leading-relaxed text-[#3A3325]'>
              ...
              helps individuals connect with universal abundance, attracting
            ...
            <p className='mt-8 max-w-full text-[17px] leading-relaxed text-[#3A3325]'>
              ...
              spiritual development. This unique modality works on both
              energetic and subconscious levels to clear scarcity patterns and
              create a pathway for abundance.
            </p>
        ...
        >
          ...
          <div className='md:order-1'>
            ...
            <p className='mt-6 text-[16px] leading-relaxed text-[#D8CFBB]'>
              Sacred Green Money Reiki is an advanced energy healing system that
              focuses on attracting abundance, prosperity, financial growth, and
              success by aligning your energy with the universal flow of wealth
              and opportunities. It combines Reiki healing energy with
              specialized abundance frequencies, symbols, and manifestation
              techniques to help remove financial blockages and cultivate a
              prosperous mindset.
            </p>
            <p className='mt-6 text-[16px] leading-relaxed text-[#D8CFBB]'>
              This healing modality is designed not only to enhance financial
              well-being but also to maintain spiritual balance, gratitude, and
              positive intention while pursuing material success.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id='learn' className={`${sectionContainer} ${sectionSpace}`}>
        <div className='grid gap-16 md:grid-cols-[0.85fr_1.15fr]'>
          <div>
            ...
            <SectionTitle>How Does Sacred Green Money Reiki Work?</SectionTitle>
            <p className='mt-6 text-[15px] leading-relaxed text-[#4A4331]'>
              Sacred Green Money Reiki works by helping individuals identify and
              release energetic, emotional, and subconscious blocks that may be
      ...
      <section className='relative overflow-hidden'>
        ...
        <div className='relative mx-auto max-w-6xl px-10 py-28 md:py-20'>
          ...
          <p className='font-serif text-2xl leading-snug text-[#F6F1E7] md:text-2xl'>
            ...
            clearing financial blockages, transforming limiting beliefs, and
            activating prosperity consciousness, Sacred Green Money Reiki
          ...
          <p className='font-serif text-2xl leading-snug text-[#F6F1E7] md:text-2xl'>
            ...
            fulfillment. It is a pathway to embracing prosperity with gratitude,
