...
export default function SwitchwordCourse () {
  return (
        ...
        >
          <div className='relative rise'>
            ...
            <p className='mt-8 max-w-full text-[17px] leading-relaxed text-[#3A3325]'>
              ...
              can be used to improve different aspects of life through focused
        ...
        >
          ...
          <div className='md:order-1'>
            ...
            <p className='mt-6 text-base leading-relaxed text-[#D8CFBB]'>
              ...
              provides practical knowledge on how to select, combine, and apply
              Switchwords effectively in everyday life.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id='learn' className={`${sectionContainer} ${sectionSpace}`}>
        <div className='grid gap-16 md:grid-cols-[0.85fr_1.15fr]'>
          <div>
            ...
            <SectionTitle>How Does a Switchword Course Work?</SectionTitle>
            <p className='mt-6 text-[15px] leading-relaxed text-[#4A4331]'>
              The Sigil Course teaches participants how to channel their
