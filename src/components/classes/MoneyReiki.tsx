...
export default function MoneyReiki () {
  return (
      ...
      <section className='relative overflow-hidden'>
        ...
        >
          <div className='relative rise'>
            ...
            <Eyebrow>Money Reiki · Coimbatore</Eyebrow>
            ...
            <p className='mt-8 max-w-full text-[17px] leading-relaxed text-[#3A3325]'>
              Money Reiki is a specialized healing modality that combines Reiki
              energy with abundance consciousness to help individuals release
              limiting beliefs around money and attract prosperity into their
              lives. At Satva Holistics, our Money Reiki Course helps
              participants align their energy with wealth, success, and
      ...
      <section className={emeraldBg}>
        ...
        >
          ...
          <div className='md:order-1'>
            <Eyebrow dark>What is Money Reiki?</Eyebrow>
            <p className='mt-6 text-[16px] leading-relaxed text-[#D8CFBB]'>
              Money Reiki is a spiritual energy healing practice that focuses on
              improving a person's relationship with money, abundance,
              prosperity, and financial well-being. It combines traditional
              Reiki healing principles with intention-based techniques aimed at
              removing energetic blocks related to wealth, success, and
              abundance.
            </p>
            <p className='mt-6 text-[16px] leading-relaxed text-[#D8CFBB]'>
              The concept behind Money Reiki is that many financial challenges
              may be connected to limiting beliefs, negative thought patterns,
              fear, lack consciousness, or emotional blocks. Money Reiki
              practitioners work with healing energy to help shift these
              patterns and encourage a more positive mindset toward prosperity.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id='learn' className={`${sectionContainer} ${sectionSpace}`}>
        <div className='grid gap-16 md:grid-cols-[0.85fr_1.15fr]'>
          <div>
            ...
            <SectionTitle>How Does Money Reiki Work?</SectionTitle>
            <p className='mt-6 text-[15px] leading-relaxed text-[#4A4331]'>
              Money Reiki is an energy healing practice that focuses on clearing
              limiting beliefs, emotional blocks, and negative patterns related
              to money, abundance, success, and prosperity. It combines Reiki
              energy with abundance-focused intentions to help create a
              healthier and more positive relationship with wealth.
            </p>
          </div>

          <div className='space-y-5'>
            <div className='flex gap-6 border-b border-[#17140F]/10 pb-2'>
      ...
      <section className='relative overflow-hidden'>
        ...
        <div className='relative mx-auto max-w-6xl px-10 py-28 md:py-20'>
          ...
          <p className='font-serif text-2xl leading-snug text-[#F6F1E7] md:text-2xl'>
            Money Reiki is more than a healing practice for wealth and
            abundance. It is a transformative journey that helps individuals
            develop a positive relationship with money, release limiting
            beliefs, and align their energy with prosperity and success. By
            combining Reiki healing energy with abundance-focused techniques,
            Money Reiki empowers individuals to cultivate confidence, attract
            opportunities, and create a balanced mindset toward financial
            well-being.
          </p>
          <p className='font-serif text-2xl leading-snug text-[#F6F1E7] md:text-2xl'>
            Whether your goal is personal growth, career success, business
            expansion, or financial stability, Money Reiki provides powerful
            tools to support your journey toward abundance, fulfillment, and a
            prosperous life.
          </p>
