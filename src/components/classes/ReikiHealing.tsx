...
const SectionTitle: React.FC<{
  ...
  <h2
    className={`font-serif text-3xl leading-tight md:text-4xl text-[] ${className}`}
  >
    {children}
  </h2>
)
...
export default function SattvaReiki () {
  return (
    <div className={`${pageBg} min-h-screen w-full antialiased`}>
      ...
      <section className='relative mx-auto max-w-full overflow-hidden px-6 pb-24 pt-10 md:px-10 md:pb-32 md:pt-16'>
        ...
        <div className='relative max-w-full rise'>
          ...
          <p className='mt-7 text-base leading-relaxed text-black md:text-base'>
            A traditional Japanese energy healing practice that promotes
            physical, emotional, mental, and spiritual well-being. This course
            introduces you to the principles of Reiki and teaches you how to
            channel universal life energy for self-healing and to support the
            healing of others.
          </p>

          <p className='mt-4 text-base leading-relaxed text-black md:text-base'>
            Whether you're beginning your healing journey or deepening an
            existing practice, Usui Reiki offers practical techniques for inner
            peace, balance, and positive energy in everyday life.
          </p>
        ...
        <div className={`${sectionContainer} ${sectionSpace}`}>
          <div className='grid gap-10 md:grid-cols-[0.9fr_1.1fr] md:gap-16'>
            ...
            <p className='text-base leading-relaxed text-white md:text-base'>
              ...
              practical sessions, helping you build confidence in using Reiki
              safely and effectively. You'll gain hands-on experience in energy
              healing, meditation, and chakra balancing, learning to weave Reiki
              into daily life rather than leaving it on a cushion.
            </p>
          </div>
        </div>
      </section>
      ...
      <section
        id='learn'
        className={`${sectionContainer} ${sectionSpace} text-black`}
      >
          ...
          <div className='grid gap-5 sm:grid-cols-2 lg:grid-cols-4'>
            {why.map(item => (
              <div key={item} className={cardClass}>
                ...
                <p className='text-[15px] leading-snug text-[#F5ECDF]'>
                  {item}
                </p>
              </div>
            ))}
